...
import hapi_chart4 "k8s.io/helm/pkg/proto/hapi/chart"
...
type InstallReleaseRequest struct {
	...
	// before marking the release as successful. It will wait for as long as timeout
	Wait bool `protobuf:"varint,9,opt,name=wait" json:"wait,omitempty"`
	// reused_subcharts specify which subcharts should use existing releases to satisfy subchart dependency
	ReusedSubcharts []*hapi_chart4.ReusedSubchart `protobuf:"bytes,10,rep,name=reused_subcharts,json=reusedSubcharts" json:"reused_subcharts,omitempty"`
}
...
func (m *InstallReleaseRequest) GetReusedSubcharts() []*hapi_chart4.ReusedSubchart {
	if m != nil {
		return m.ReusedSubcharts
	}
	return nil
}
...
var fileDescriptor0 = []byte{
	...
	,
}
